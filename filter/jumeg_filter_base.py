...
#--- filter_info short string
    ...
    def calc_notches(self,nfreq,nfreq_max=0.0):
      ...
      #--- ck for max notches to calc 
        ...
        if self.verbose:
           print("calculate Notches: {}".format(self.filter_notch)) 
     ...
     # from joblib import Parallel, delayed
       ...
       if data.ndim > 1 :
          ...
          for ichan in picks:
              ...
              if self.verbose : 
                 print("  => filter channel idx : {} dc correction: {}".format(ichan,self.remove_dcoffset) )
       else:
