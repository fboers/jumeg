...
class JuMEG_TSV_FreeType_Text(object):
      """"
      """
      def __init__(self,font='Vera.ttf',size=20,path=None):
      ...
      def draw(self)    :
          ...
          gl.glColor4f( 1, 1.0, 1.0, 1.0 )
          
          gl.glEnable( gl.GL_BLEND )
          gl.glBlendFunc( gl.GL_SRC_ALPHA, gl.GL_ONE_MINUS_SRC_ALPHA )
          gl.glBlendColor( 1, 1.0, 1.0, 1.0 )

          self.shader.bind()
          self.shader.uniformi('texture', 0)
          self.shader.uniformf('pixel', 1.0/512, 1.0/512)
          self.shader.uniformf('text_color', *self.text_color )
