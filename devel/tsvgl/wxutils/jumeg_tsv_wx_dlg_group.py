...
from jumeg.tsvgl.wxutils.jumeg_tsv_wxutils import DLGButtonPanel,ColorComboBoxDialog
      ...
      def InitDlg(self):
       ...
       #---global group optin
         ...
         #hbox.Add(self._ctrl_group,0,flag=wx.ALL|wx.EXPAND, border=10)
          #self._ctrl_nb_groups = ScrolledWrapper(self,CtrlGroup,self.opt,label="GROUPS")        obj = evt.GetEventObject()
