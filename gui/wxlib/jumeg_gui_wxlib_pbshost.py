...
'''
class JuMEG_PBSHostsInfo(object):
    #__slots__ =["name","nodes","maxnodes","kernels","maxkernels","python_version"]
   def __init__(self,**kwargs):
        super().__init__()
        self._param={ "name": "local", "nodes": 1, "maxnodes": 1, "kernels": 1, "maxkernels": 1 ,
                     "python_version":"None"}
        self._init(**kwargs)
   ...
   @property
   def python_versions( self ): return self._get_param["python_versions"]
   @python_versions.setter
   def python_versions( self, v ):
       if isinstance(v, (list)):
          self._set_param["python_versions"] =v
   ...
   def _update_from_kwargs(self,**kwargs):
       for k in self._param.fromkeys():
           self._param[k] = kwargs.get(k,self._param[k])
    ...
    def __init__(self,**kwargs):
        ...
        self._template_default = {
                ...
                "hosts"          : {
                    ...
                    "mrcluster": { "name": "mrcluster", "nodes": 1, "maxnodes": 10, "kernels": 1, "maxkernels": 8 }
                    }
                }
