...
from jumeg.gui.utils.jumeg_gui_utils_pdfs  import JuMEG_Utils_PDFsMEEG,JuMEG_Utils_PDFsBTi
...
class JuMEG_wxPDFBase(wx.Panel):
    ...
    # --- Label + line
        ...
        self.Bind(wx.EVT_BUTTON, self.DeSelectAll, self._bt_deselect)
...
class JuMEG_wxPDFBTi(JuMEG_wxPDFBase):
    ...
    @property
    def emptyroom(self): return self._emptyroom
    @emptyroom.setter
    ...
    def _init_defaults(self):
        ...
        self._headline       = "{} {:^6} {:^12} {:^10} {:^12} {:^6} {:^10}".format("4D/BTi","Id","Scan","Date","Time","Run","PDF Name")
    ...
    def update(self,pdfs=None,n_pdfs=None,reset=True):
        ...
        for subject_id in self._pdfs["bti"]:
            ...
            for idx in range(len(self._pdfs["bti"][subject_id])):
              ...
              # --- init  mne checkbox
                ckb = wx.CheckBox(self._pnl_pdf,wx.NewId(),label=self._checkbox_label(pdf_name.replace("/","_").replace('@',"_")),
